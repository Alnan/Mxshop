...
class AdminSplitDateTime(forms.SplitDateTimeWidget):
    ...
    def render(self, name, value, attrs=None):
        ...
        #input_html: ['<input type="text" name="add_time_0" value="2018/08/24" class="date-field form-control admindatewidget" size="10" required id="id_add_time_0" />\n\n<input type="text" name="add_time_1" value="00:19" class="time-field form-control admintimewidget" size="8" required id="id_add_time_1" />']
        # return input_html
